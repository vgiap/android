...
public class Constants {
    ...
    public static final String INTENT_EXTRA_RESOURCE_POSITION = "resource_position";
    public static final String INTENT_EXTRA_RESOURCE_TYPE = "resource_type";
    public static final String INTENT_EXTRA_SAVE_PATH = "save_path";
